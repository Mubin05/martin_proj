...
const ProductCard = ({ product }) => (
  <div className="product-card bg-white rounded-lg shadow-xl transition-transform duration-30 hover:shadow-xl hover:scale-20 flex flex-col overflow-hidden">
    ...
    <button className="w-full bg-[#AF8F0F] text-white py-2 px-4 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 transition-colors duration-300">
      Add to Cart
    </button>
  </div>
);
